...
//        return Jwts.parser().setSigningKey(jwtSigningKey).parseClaimsJwt(token).getBody();
      return Jwts.parser().setSigningKey(jwtSigningKey.getBytes(StandardCharsets.UTF_8))
    ...
    private String createToken(Map<String,Object> claims, UserDetails userDetails){
        return Jwts.builder().setClaims(claims)
                ...
                .signWith(SignatureAlgorithm.HS256,jwtSigningKey.getBytes(StandardCharsets.UTF_8)).compact();
